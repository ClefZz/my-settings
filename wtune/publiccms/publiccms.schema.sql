...
--
-- Host: localhost    Database: publiccms
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=122 DEFAULT CHARSET=utf8mb4 COMMENT='分类';
...
CREATE TABLE `cms_category_type` (
  ...
  PRIMARY KEY (`id`),
  KEY `site_id` (`site_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='分类类型';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='页面数据';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cms_tag` (
  ...
  PRIMARY KEY (`id`),
  KEY `site_id` (`site_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COMMENT='标签';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cms_tag_type` (
  ...
  PRIMARY KEY (`id`),
  KEY `site_id` (`site_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='标签类型';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='搜索词';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `log_operate` (
  ...
  KEY `site_id` (`site_id`),
  KEY `channel` (`channel`)
) ENGINE=InnoDB AUTO_INCREMENT=175 DEFAULT CHARSET=utf8mb4 COMMENT='操作日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='任务计划日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `log_upload` (
  ...
  KEY `file_type` (`file_type`),
  KEY `file_size` (`file_size`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='上传日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_app` (
  ...
  KEY `site_id` (`site_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='应用';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_extend` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='扩展';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COMMENT='任务计划';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-10-26 14:21:19
